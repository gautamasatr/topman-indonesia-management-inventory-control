...
namespace TopmanIdManagementAndInventorycontrol
{
    public partial class FormUpdateDepartment : Form
    {
        ...
        public FormUpdateDepartment()
        {
            ...
            lblId.Text = UCDepartment.uid;
            txtDepartment.Text = UCDepartment.udepartment;

            this.pnlTop.MouseDown += new System.Windows.Forms.MouseEventHandler(this.pnlTop_MouseDown);
        }

        void UpdateDataDepartment()
        {
            sql = "UPDATE department "
                + "SET name = '" + txtDepartment.Text.ToString().ToUpper() + "' "
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Department Sucessfully Updated", "Warning", MessageBoxButtons.OK);
                this.Close();
            }
        }
