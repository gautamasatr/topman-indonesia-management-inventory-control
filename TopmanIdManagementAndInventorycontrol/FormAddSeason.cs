...
namespace TopmanIdManagementAndInventorycontrol
{
    public partial class FormAddSeason : Form
    {
        ...
        {
            sql = "SELECT id FROM season WHERE id = '" + checkid + "'";
            conn.Open();
        ...
        //code untuk insert data season baru
        void InsertDataSeason()
        {
            string id = txtId.Text.ToString();
            string season = txtSeason.Text.ToString();

            sql = "INSERT INTO season "
            + "VALUES ('" + id.ToUpper() + "', '" + season.ToUpper() + "' )";
            conn.Open();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtId.Text) || string.IsNullOrEmpty(txtSeason.Text))
            ...
            {
                InsertDataSeason();
                MessageBox.Show("New Season Sucessfully Added", "Warning", MessageBoxButtons.OK);
                this.Close();
            }
        }
